...
void SsaoApp::OnMouseLeftDown(int x, int y, short keyState)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void SsaoApp::OnMouseLeftUp(int x, int y, short keyState)
{
	ReleaseCapture();
}

void SsaoApp::OnMouseMove(int x, int y, short keyState)
{
