...
class DisplacementMapApp : public MainWindow
{
public:
	DisplacementMapApp(HINSTANCE hInstance);
	DisplacementMapApp(const DisplacementMapApp& rhs) = delete;
	DisplacementMapApp& operator=(const DisplacementMapApp& rhs) = delete;
	~DisplacementMapApp();
