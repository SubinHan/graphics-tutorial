...
void QuaternionApp::OnMouseLeftDown(int x, int y, short keyState)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void QuaternionApp::OnMouseLeftUp(int x, int y, short keyState)
{
	ReleaseCapture();
}

void QuaternionApp::OnMouseMove(int x, int y, short keyState)
{
...
void QuaternionApp::AnimateMaterials(const GameTimer& gt)
{
...
void QuaternionApp::UpdateShadowTransform(const GameTimer& gt)
{
...
void QuaternionApp::UpdateShadowPassCB(const GameTimer& gt)
{
...
void QuaternionApp::UpdateSsaoCB(const GameTimer& gt)
{
...
void QuaternionApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Default.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Default.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["shadowVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Shadows.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["shadowOpaquePS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Shadows.hlsl", nullptr, "PS", "ps_5_1");
	mShaders["shadowAlphaTestedPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Shadows.hlsl", alphaTestDefines, "PS", "ps_5_1");

	mShaders["debugVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\ShadowDebug.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["debugPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\ShadowDebug.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["drawNormalsVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\DrawNormals.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["drawNormalsPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\DrawNormals.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["ssaoVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Ssao.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["ssaoPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Ssao.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["ssaoBlurVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\SsaoBlur.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["ssaoBlurPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\SsaoBlur.hlsl", nullptr, "PS", "ps_5_1");

	mShaders["skyVS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Sky.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["skyPS"] = DxUtil::CompileShader(L"22Quaternion\\Shaders\\Sky.hlsl", nullptr, "PS", "ps_5_1");
...
CD3DX12_CPU_DESCRIPTOR_HANDLE QuaternionApp::GetCpuSrv(int index)const
{
...
CD3DX12_GPU_DESCRIPTOR_HANDLE QuaternionApp::GetGpuSrv(int index)const
{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE QuaternionApp::GetDsv(int index)const
{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE QuaternionApp::GetRtv(int index)const
{
