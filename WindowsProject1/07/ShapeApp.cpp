...
void ShapeApp::BuildShapeGeometry()
{
    ...
    const std::string skullPath = "07\\Models\\skull.txt";
    GeometryGenerator::MeshData skull = geoGen.CreateMeshWithFile(skullPath);
    ...
    skullSubmesh.IndexCount = skull.Indices32.size();
    ...
    auto totalVertexCount = skull.Vertices.size();
...
void ShapeApp::BuildRenderItems()
{
    ...
    XMStoreFloat4x4(&skullRitem->World, XMMatrixTranslation(0.0f, 0.0f, 0.0f));
    skullRitem->ObjCBIndex = 0;
    skullRitem->Geo = geometries["shapeGeo"].get();
